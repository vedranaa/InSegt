...
//         vector<int> r_id = randperm(t-f+1, tree.branch_fac); // indices of random patches
//         printf("rand perm. Node %d. Node+tree.branch_fac-1 %d\n",node,node+tree.branch_fac-1);
        ...
        int nrhs, const mxArray *prhs[])
{
    ...
    const mwSize *dim; // image dimensions
